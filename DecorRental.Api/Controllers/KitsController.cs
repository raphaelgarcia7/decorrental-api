...
public class KitsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetReservations(Guid id, CancellationToken cancellationToken)
    {
        ...
        var response = kitTheme.Reservations
            .Select(reservation => new ReservationResponse(
                ...
                reservation.CustomerNeighborhood,
                reservation.CustomerCity,
    ...
    public async Task<IActionResult> Reserve(Guid id, [FromBody] ReserveKitRequest request, CancellationToken cancellationToken)
    {
        var command = new ReserveKitCommand(
            KitThemeId: id,
            KitCategoryId: request.KitCategoryId,
            StartDate: request.StartDate,
            EndDate: request.EndDate,
            AllowStockOverride: request.AllowStockOverride,
            StockOverrideReason: request.StockOverrideReason,
            CustomerName: request.CustomerName,
            CustomerDocumentNumber: request.CustomerDocumentNumber,
            CustomerPhoneNumber: request.CustomerPhoneNumber,
            CustomerAddress: request.CustomerAddress,
            Notes: request.Notes,
            HasBalloonArch: request.HasBalloonArch,
            IsEntryPaid: request.IsEntryPaid,
        ...
        var response = new ReserveKitResponse(
            ...
            result.CustomerZipCode,
            result.CustomerStreet,
            result.CustomerNumber,
            result.CustomerComplement,
            result.CustomerNeighborhood,
            result.CustomerCity,
    ...
    public async Task<IActionResult> GetContractData(Guid id, Guid reservationId, CancellationToken cancellationToken)
    {
        ...
        var response = new ContractDataResponse(
            ...
            contractData.CustomerZipCode,
            contractData.CustomerStreet,
            contractData.CustomerNumber,
            contractData.CustomerComplement,
            contractData.CustomerState,
            contractData.CustomerReference,
